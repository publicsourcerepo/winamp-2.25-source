...
static void __cdecl vc_placebo_mix(void *srce, SLONG *dest, INT64S index, INT64S increment, SLONG todo, VC_RESFILTER *resfilter, VOLINFO *volinfo) {};

VMIXER VC_MIXER_PLACEBO =
{   NULL,

    BLAH("Placebo Mixer v1.0"),
