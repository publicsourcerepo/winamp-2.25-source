...
// =====================================================================================
{
    ...
    if((si=(MD_SAMPLE *)MikMod_calloc(md->allochandle, 1, sizeof(MD_SAMPLE)))==NULL) return NULL;
    ...
    //si->data = MikMod_malloc(si->length);
...
// =====================================================================================
{
    ...
    si = (MD_SAMPLE *)MikMod_calloc(md->allochandle, 1,sizeof(MD_SAMPLE));
    si->md = md;
    return si;
}
...
// =====================================================================================
{
    ...
    newug = (MD_SAMPLE *)MikMod_malloc(src->md ? src->md->allochandle : NULL, sizeof(MD_SAMPLE));
