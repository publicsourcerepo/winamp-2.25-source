...
// =====================================================================================
    MDRIVER *Mikmod_Init(uint mixspeed, uint latency, void *optstr, uint chanmode, uint cpumode, uint drvmode, MD_DEVICE *device)
// =====================================================================================
// mixspeed -
...

{
    ...
    memcpy(&md->device, device, sizeof(md->device));
    ...
    if (md->device.SetMode(md, mixspeed, drvmode, chanmode, cpumode))
	{
		Mikmod_Exit(md);
		return 0;
	}
