...
//CUT #define SL_SUSTAIN_REVERSE  (1ul<<5)   //    considering how much work it was!)
...
//CUT #define SF_BIG_ENDIAN       (1ul<<4)
#define SF_DELTA_BYTES      (1ul<<5)
...
#define DMODE_CUBIC   (1ul<<9)	 // yay
#define DMODE_24BITS (1ul<<10)	//YAY
#define DMODE_FIR            (1ul<<11) // yay indeed
...
// =====================================================================================
{   
//CUT    void    (*callback)(struct MD_VOICESET *voiceset, uint voice, void *dest, uint len);
...
MMEXPORT MDRIVER *Mikmod_Init(uint mixspeed, uint latency, void *optstr, uint chanmode, uint cpumode, uint drvmode, MD_DEVICE *device);
