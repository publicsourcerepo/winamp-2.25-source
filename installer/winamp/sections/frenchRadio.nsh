...
!ifdef FULL
	...
	!macro FrenchRadio_InsertInstallSections
		...
		${WinampSection} "FrenchRadio" $(IDS_SEC_GEN_FRENCHRADIO)  IDX_SEC_GEN_FRENCHRADIO  ; >>> [French Radio plugin]
			...
			!define FRENCH_RADIO_SOURCE		"${FRENCH_RADIO_SOURCE_BASE}\files\Plugins_part1\Todae\LMPwa\img"
			File "${FRENCH_RADIO_SOURCE}\EDIT.png"
			File "${FRENCH_RADIO_SOURCE}\FAV.png"
			File "${FRENCH_RADIO_SOURCE}\HELP.png"
			File "${FRENCH_RADIO_SOURCE}\LIST.png"
			File "${FRENCH_RADIO_SOURCE}\LMP_button.bmp"
			File "${FRENCH_RADIO_SOURCE}\play.png"
			File "${FRENCH_RADIO_SOURCE}\playb.png"
			File "${FRENCH_RADIO_SOURCE}\play_on.png"
			File "${FRENCH_RADIO_SOURCE}\play_on_small.png"
			File "${FRENCH_RADIO_SOURCE}\RMP_icon_fav.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_icon_logo.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_fav.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_fav2.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_favon.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_play.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_playon.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_stop.bmp"
			File "${FRENCH_RADIO_SOURCE}\RMP_UI_stopon.bmp"
			...
			File "${FRENCH_RADIO_SOURCE}\stopb.png"
			File "${FRENCH_RADIO_SOURCE}\stop_on.png"
			
			;languages
			SetOutPath "$INSTDIR\Plugins\Todae\LMPwa\lang"
			!undef FRENCH_RADIO_SOURCE
			!define FRENCH_RADIO_SOURCE "${FRENCH_RADIO_SOURCE_BASE}\files\Plugins_part1\Todae\LMPwa\lang"
			...
			SetOutPath "$INSTDIR\Plugins"
			!undef FRENCH_RADIO_SOURCE
			!define FRENCH_RADIO_SOURCE "${FRENCH_RADIO_SOURCE_BASE}\files\Plugins_part1"
			File "${FRENCH_RADIO_SOURCE}\gen_LMPwa.dll"
			
			; user settings
			SetOutPath "$APPDATA\Todae\LMPwa"
			!undef FRENCH_RADIO_SOURCE
			!define FRENCH_RADIO_SOURCE "${FRENCH_RADIO_SOURCE_BASE}\files\LMPwa"
			...
			!undef FRENCH_RADIO_SOURCE
			!define FRENCH_RADIO_SOURCE "${FRENCH_RADIO_SOURCE_BASE}\files\LMPwa\256x256"
