...
!ifndef WINAMP64
	ReadRegStr $0 HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Winamp" "SonicRef" ; this entry must stay "Winamp"
	${If} $0 = 1
		SetOutPath "$PLUGINSDIR\PrimoRedist"
		File "${PRIMOSDK_REDIST_PATH}\pxsetup.exe"
		ExecWait '"$PLUGINSDIR\PrimoRedist\pxsetup.exe" /uninstall' $0
		DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Winamp" "SonicRef"
	${ElseIf}  $0 > 1
		IntOp $0 $0 - 1
...
!endif
	...
	DeleteRegKey HKLM "CLSID\{46986115-84D6-459c-8F95-52DD653E532E}"
	DeleteRegKey HKLM "CLSID\{77A366BA-2BE4-4a1e-9263-7734AA3E99A2}"
