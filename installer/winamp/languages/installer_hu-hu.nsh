...
${LangFileString} installStandart "Általános"
...
${LangFileString} installerContainsBundle "Ez a telepítő a teljes extra csomagot tartalmazza."
${LangFileString} installerContainsPro "Ez a telepítő a pro csomagot tartalmazza."
${LangFileString} installerContainsFull "Ez a telepítő a teljes telepítő csomagot tartalmazza."
${LangFileString} installerContainsStandard "Ez a telepítő csak az általános csomagot tartalmazza."
...
${LangFileString} verHistHeader "Verziótörténet"
${LangFileString} verHistHeaderSub "A Winamp verziótörténete"
${LangFileString} verHistTop "Kérem tekintse meg a verziótörténetet a folytatás előtt:"
${LangFileString} verHistBottom "Fordítson különös figyelmet a pirossal jelölt frissítésekre."
${LangFileString} verHistButton "Befejezés"
...
${LangFileString} whatNew "Újdonságok"
...
${LangFileString} secSonicBurning "Sonic másolás/írás támogatás"
...
${LangFileString} secDVD "DVD lejátszás (külső DVD dekódoló szükséges)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "eMusic ikon + 50 ingyenes MP3!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "AOL Music Now ikon + 30 napos ingyenes próbaidőszak!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Ingyenes vírusvédelem az Active Virus Shield-del!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "Ingyenes Active Security Monitor"
!endif
...
${LangFileString} secOrb "Távoli média"
...
${LangFileString} sec_ML_DASH "Winamp vezérlőpult"
...
${LangFileString} IDS_SEC_ML_ADDONS		"Winamp bővítmény felfedező"
${LangFileString} IDS_SEC_MUSIC_BUNDLE	"Extra MP3-ak letöltése"
...
${LangFileString} IDS_RUN_OPTIMIZING			"Optimalizálás..."
...
${LangFileString} IDS_PAGE_FINISH_SETMUSICBUNDLE	"Extra MP3-ak felvétele a Winamp lejátszólistájára"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Hozza ki a legtöbbet a $(^NameDA)ból"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Válasszon az alábbi bővített lehetőségek közül, hogy a legtöbbet kihozza a $(^NameDA)ból."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"A legjobb $(^NameDA) élményt az alábbi bővített lehetőségekkel teheti teljessé."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"letöltési méret:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"már telepítve van"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"csak Windows XP-re vagy újabbra"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MB"
${LangFileString} IDS_PAGE_BUNDLE_KB		"KB"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® távirányító" ; keep for uninstaller
;${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Élvezze a zenéit és videóit menet közben. Sugározza az otthoni zenét a Winamp.com-ról \
;                                            kompatibilis mobil eszközök, Nintendo® Wii™, Sony® PlayStation® 3 és Microsoft® Xbox™ 360 számára."
${LangFileString} IDS_BUNDLE2_NAME			"Winamp® eszköztár"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Közvetlenül a böngészőből irányítja a Winampot és hozzáférést biztosít a \
													SHOUTcast állomásokhoz."
${LangFileString} IDS_BUNDLE21_NAME			"Legyen az AOL® Search az alapértelmezett keresőm"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Hagyja, hogy a Winamp segítsen Önnek keresni a weben a Winamp keresővel."
${LangFileString} IDS_WINAMP_SEARCH			"Winamp kereső"

${LangFileString} IDS_BUNDLE3_NAME			"50 ingyenes MP3 letöltés +1 ingyenes hangoskönyv az eMusic-tól"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Elindít egy kéthetes ingyenes eMusic próbaidőszakot és letölthet 50 ingyenes MP3 zenét, plusz 1 ingyenes \
                                             hangoskönyvet. A letöltött zenéket és a hangoskönyvet megtarthatja akkor is, ha lemondja a szolgáltatást."
...
;Winamp3
${LangFileString} msgWA3			"Winamp3 észlelve..."
${LangFileString} msgWA3_UPGRADE		"Winamp3 észlelve. Frissíti a Winamp3 telepítését a Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} verziójára és átviszi a témákat a(z) ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} verzióba?$\r$\n(Javasolt az Igen gombra kattintani, de a Nem gombbal a Winamp3-tól eltérő könyvtárba telepítheti a Winamp 5.x változatát)"
${LangFileString} msgWA3_MIGRATE		"Témák átmásolása..."
${LangFileString} msgWA3_REMOVE			"Winamp3 eltávolítása..."
${LangFileString} msgWA3_REMOVE2		"Nem minden fájl lett eltávolítva a(z) '$0' könyvtárból.$\r$\nHa szeretné eltávolítani a fájlokat a könyvtárból, akkor kézzel letörölheti őket."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic könyvtár, hanglemezek másolásához és írásához"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"MP3 formátum kódolásának támogatása"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Vezérlőpult, egy opcionális kezdőlap a médiatárhoz"
...
${LangFileString} IDS_SEC_GEN_DROPBOX_DESC		"A nemsokára érkező Dropbox bővítmény alpha verziója. Nyomja le a Ctrl-Shift-D-t az aktiváláshoz"
${LangFileString} IDS_SEC_ML_IMPEX_DESC			"iTunes-komptibilis médiatár adatbázist importáló/exportáló bővítmény"
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"A Winamp Orgler™-rel követheti, feltérképezheti és megoszthatja, hogy mely számokat hallgatja"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Fedezzen fel és töltsön le újabb bővítményeket a Winamphoz"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Ingyenes zenék letöltése a Winamp Musictól"

${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"Válassza ki a kapcsolódó programokat az eltávolításhoz."
${LangFileString} IDS_UNINSTALL_COMPONENTS_GROUP_DESC	"Eltávolítja a $(^NameDA)ot a számítógépéről."

;${LangFileString} IDS_UNINSTALL_COMPONENTS_HEADER		"A következő $(^NameDA)hoz kapcsolódó programok el lesznek távolítva. A változtatáshoz vegye ki a jelölést a megfelelő négyzetből:"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"A következő Winamphoz kapcsolódó programok el lesznek távolítva:"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER		"Megjegyzés: bármikor eltávolíthatja ezeket a programokat a Windows Vezérlőpultjával."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"Közvetlenül a böngészőből irányítja a $(^NameDA)ot és hozzáférést biztosít a SHOUTcast állomásokhoz."
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"Élvezze a zenéit és videóit menet közben."
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Winamp észlelő bővítmények Mozilla Firefox és Internet Explorer böngészőkhöz."
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC				"Zene letöltések, MP3 letöltések, MP3 számok az eMusic.com-tól"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"$2 eltávolítása..."
