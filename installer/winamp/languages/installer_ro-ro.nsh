...
${LangFileString} installerContainsBundle	" Acest pachet de instalare conține versiunea completă cu opțiuni suplimentare."
${LangFileString} installerContainsPro		" Acest pachet de instalare conține versiunea profesională."
${LangFileString} installerContainsFull		" Acest pachet de instalare conține versiunea completă."
${LangFileString} installerContainsStandard " Acest pachet de instalare conține versiunea standard."
...
${LangFileString} verHistHeader				"Istoric versiuni"
${LangFileString} verHistHeaderSub			"Istoricul versiunilor Winamp"
${LangFileString} verHistTop				"Această versiune vine cu următoarele actualizări:"
${LangFileString} verHistBottom				"Modificările marcate cu roșu necesită o atenție specială."
${LangFileString} verHistButton				"Terminare"
...
${LangFileString} whatNew			"Ce-i nou"
...
${LangFileString} secSonicBurning	"Extragere/inscripționare CD-uri"
...
${LangFileString} secDVD			"Redare DVD (necesită un decodor extern)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic		"Pictogramă eMusic și ofertă pentru 50 MP3-uri gratuite!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow		"Pictogramă AOL Music Now și ofertă pentru 30 zile testare gratuită!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS	"Protecție gratuită cu Active Virus Shield!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM	"Active Security Monitor - GRATIS!"
!endif
...
${LangFileString} secOrb			"Mediatecă la distanță"
...
${LangFileString} sec_ML_DASH		"Tablou de bord"
...
${LangFileString} IDS_SEC_ML_ADDONS			"Extensii Winamp"
${LangFileString} IDS_SEC_MUSIC_BUNDLE		"Muzică gratuită la pachet"
...
${LangFileString} IDS_RUN_OPTIMIZING				"Optimizare..."
...
${LangFileString} IDS_PAGE_FINISH_SETMUSICBUNDLE	"Adăugare piese gratuite la pachet în gestionarul de liste"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Maximum de la $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Opțiuni suplimentare pentru funcționalitatea maximă a $(^NameDA)."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"Obțineți cea mai bună experiență cu $(^NameDA) alegând aceste facilități suplimentare."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"Dimensiune:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"deja instalat"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"numai pentru Windows XP sau mai nou"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MO"
${LangFileString} IDS_PAGE_BUNDLE_KB		"kO"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Remote" ; keep for uninstaller
;${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Bucurați-vă de muzica și înregistrările Dvs. video oriunde ați fi. Redați muzica personală de la Winamp.com, \
;												telefoane mobile compatibile, Nintendo® Wii™, Sony® PlayStation® 3 și Microsoft® Xbox™ 360."
${LangFileString} IDS_BUNDLE2_NAME			"Bară de instrumente Winamp®"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Controlați Winamp direct din navigatorul web și obțineți acces instantaneu \
												la SHOUTcast."
${LangFileString} IDS_BUNDLE21_NAME			"AOL® Search - motor de căutare implicit"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Lăsați Winamp să vă ajute în căutările pe internet cu AOL® Search."
${LangFileString} IDS_WINAMP_SEARCH			"Winamp Search"
${LangFileString} IDS_BUNDLE3_NAME			"50 descărcări MP3 gratuite + 1 carte audio de la eMusic"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Abonați-vă gratuit la eMusic timp de 2 săptămâni și bucurați-vă de 50 descărcări MP3 plus o carte \
												audio. Muzica și cartea rămân ale Dvs. chiar și după ce veți anula abonamentul."
; messages
...
;Winamp3
${LangFileString} msgWA3				"A fost detectat Winamp3..."
${LangFileString} msgWA3_UPGRADE		"A fost detectat Winamp3. Doriți actualizarea și migrarea interfețelor la Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND}?$\r$\n(Selectați Da pentru actualizare - opțiune recomandată, sau Nu pentru păstrarea separată a instalărilor Winamp3 și Winamp 5.x)"
${LangFileString} msgWA3_MIGRATE		"Migrare interfețe..."
${LangFileString} msgWA3_REMOVE			"Eliminare instalare Winamp3..."
${LangFileString} msgWA3_REMOVE2		"Fișierele din „$0” nu au fost eliminate în totalitate.$\r$\nDacă doriți să eliminați toate fișierele din acest dosar, le puteți șterge manual."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Bibliotecă Sonic - permite extragerea și inscripționarea CD-urilor audio"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"Suport pentru extragerea și transcodarea în formatul MP3"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Portal local opțional pentru mediateca Winamp"
...
${LangFileString} IDS_SEC_GEN_DROPBOX_DESC		"Versiunea alpha a extensiei Dropbox. Se activează cu Ctrl+Shift+D"
${LangFileString} IDS_SEC_ML_IMPEX_DESC			"Extensie pentru importul/exportul mediatecii compatibile iTunes"
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"Permite urmărirea, schematizarea și partajarea istoricului pieselor ascultate"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Descoperă și adaugă extensii în Winamp"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Descarcă și adaugă în listă muzică gratuită de la Winamp Music"

${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"Permite alegerea programelor asociate pentru a fi dezinstalare."
${LangFileString} IDS_UNINSTALL_COMPONENTS_GROUP_DESC	"Elimină $(^NameDA) din computer."

;${LangFileString} IDS_UNINSTALL_COMPONENTS_HEADER		"Următoarele programe asociate cu $(^NameDA) vor fi eliminate. Pentru modificare, deselectați casetele corespunzătoare:"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"Următoarele programe asociate cu Winamp vor fi eliminate în această dezinstalare:"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER		"Notă: Puteți dezinstala aceste programe oricând prin intermediul Panoul de control al Windows."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"Controlează $(^NameDA) direct din navigatorul web și permite accesul direct la SHOUTcast."
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"Bucurațivă de muzica și filmele Dvs. din mers."
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Extensie Detector Winamp pentru Mozilla Firefox și Internet Explorer."
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC				"Descărcare de muzică în format mp3 de la eMusic.com"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"Dezinstalare $2..."
