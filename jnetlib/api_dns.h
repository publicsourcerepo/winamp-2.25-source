#ifndef __WASABI_API_DNS_H_
#define __WASABI_API_DNS_H_
...
public:
  ...
  //int reverse(unsigned long addr, char *hostname, size_t hostnameSize);  // see DNS_REVERSE_* for return values
};
...
/*
inline int api_dns::reverse(unsigned long addr, char *hostname, size_t hostnameSize)
	{
		return _call(API_DNS_REVERSE, (int)DNS_REVERSE_UNRESOLVABLE, addr, hostname, hostnameSize);
	}
*/
