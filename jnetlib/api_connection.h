#ifndef __WASABI_API_CONNECTION_H
#define __WASABI_API_CONNECTION_H
...
//	    API_CONNECTION_RECEIVEINTEGER=150,
	...
	//unsigned int ReceiveInteger(void);
...
/*
inline unsigned int api_connection::ReceiveInteger(void)
{
	return _call(API_CONNECTION_RECEIVEINTEGER, (unsigned int)0);
}
*/
