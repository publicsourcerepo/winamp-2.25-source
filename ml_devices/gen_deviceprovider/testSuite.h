...
private:
	typedef nu::PtrList<Device> DeviceList;
	typedef nu::PtrList<ifc_devicetype> TypeList;
	typedef nu::PtrList<ifc_deviceconnection> ConnectionList;
	typedef nu::PtrList<ifc_devicecommand> CommandList;

	typedef nu::PtrList<char> NameList;
