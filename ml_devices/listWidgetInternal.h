...
typedef nu::PtrList<ListWidgetConnection> ListWidgetConnectionList;
...
typedef nu::PtrList<ListWidgetItem> ListWidgetItemList;
...
typedef nu::PtrList<ListWidgetGroup> ListWidgetGroupList;
...
typedef nu::PtrList<ListWidgetCategory> ListWidgetCategoryList;
