...
public:
	...
	FileType::FileType() : wtype(0), type(0), description(0), isProtocol(false), avType(AUDIO)
	{
	}
	...
	FileType::FileType(const FileType &copy) :wtype(0), type(0), description(0)
	{
		operator =(copy);
	}
...
public:
	...
	typedef Vector<FileType> TypeList;
