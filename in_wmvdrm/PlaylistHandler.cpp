...
api_playlistloader *WPLHandler::CreateLoader(const wchar_t *filename)
{
	return new WPLLoader;
}

void WPLHandler::ReleaseLoader(api_playlistloader *loader)
{
	WPLLoader *pls;
...
api_playlistloader *ASXHandler::CreateLoader(const wchar_t *filename)
{
	return new ASXLoader;
}

void ASXHandler::ReleaseLoader(api_playlistloader *loader)
{
	ASXLoader *pls;
