#ifndef NULLSOFT_WAVEOUTH
#define NULLSOFT_WAVEOUTH
...
public:
	...
	const wchar_t * GetError() {return error;}
...
public:
	...
	bool PrintState(wchar_t * z, size_t cchLength);
