...
#define READ(type, name) config_##name = (type)wmConfig.cfg_int(L"config_"## L ## #name, default_##name)
#define WRITE(type, name) wmConfig.cfg_int(L"config_"## L ## #name, default_##name) = (int)config_##name
