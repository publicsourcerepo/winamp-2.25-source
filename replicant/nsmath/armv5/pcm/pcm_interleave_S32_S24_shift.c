...
void armv5_vfp_nsmath_pcm_Convert_S32_S24_decimate(uint8_t *destination, const int32_t **source, size_t channels, size_t count_per_channel, unsigned int decimation_bits)
{
		size_t b, c;
