/*****************************************************************************
   ...
   $Id: mathlib.c,v 1.1 2007/05/29 16:02:35 audiodsp Exp $
...
#if defined _M_IX86 || ( defined __i386__ && !defined __CYGWIN__ && !defined __APPLE_CC__ )
...
#if defined __APPLE_CC__ && defined __ppc__ && defined __OPTIMIZE__
