...
extern "C" {
	...
	NX_API FILE *NXFile_fopen(nx_uri_t filename, nx_file_FILE_flags_t flags);
	...
	NX_API ns_error_t NXFileOpenProgressiveDownloader(nx_file_t *out_file, nx_uri_t filename, nx_file_FILE_flags_t flags, jnl_http_t http);
