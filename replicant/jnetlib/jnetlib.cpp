...
#ifdef _WIN32
const char* inet_ntop_xp(int af, const void* src, char* dst, int cnt)
{
...
PCSTR WSAAPI inet_ntop_win32(INT Family, PVOID pAddr, PSTR pStringBuf, size_t StringBufSize) {
	static int first_inet_ntop = 1;
    typedef PCSTR (WSAAPI * win32_inet_ntop)(INT, PVOID, PSTR, size_t);
    static win32_inet_ntop pwin32_inet_ntop;
	...
	return (pwin32_inet_ntop ? pwin32_inet_ntop(Family, pAddr, pStringBuf, StringBufSize) : inet_ntop_xp(Family, pAddr, pStringBuf, StringBufSize));
}
#endif
