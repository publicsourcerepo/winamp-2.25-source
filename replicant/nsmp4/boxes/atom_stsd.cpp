...
MP4StsdAtom::MP4StsdAtom(MP4Atom *parent, const char *type) : MP4Atom(parent, type) 
{
	AddVersionAndFlags();
	...
	ExpectChildAtom<MP4SoundAtom>("mp4a", Optional, Many);
	...
	ExpectChildAtom("rtp ", Optional, Many);
 	ExpectChildAtom<MP4AmrAtom>("samr", Optional, Many); // For AMR-NB
 	ExpectChildAtom<MP4AmrAtom>("sawb", Optional, Many); // For AMR-WB
 	ExpectChildAtom("s263", Optional, Many); // For H.263
	ExpectChildAtom<MP4Avc1Atom>("avc1", Optional, Many);
	ExpectChildAtom<MP4SoundAtom>("alac", Optional, Many);
	ExpectChildAtom("text", Optional, Many);
	ExpectChildAtom<MP4SoundAtom>("m4ae", Optional, Many);
}
