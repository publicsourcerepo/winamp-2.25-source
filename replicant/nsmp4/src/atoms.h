...
class MP4SoundAtom : public MP4Atom {
 public:
  MP4SoundAtom(MP4Atom *parent, const char *type);
  void Generate();
  void Read();
protected:
...
class MP4AmrAtom : public MP4Atom {
 public:
  MP4AmrAtom(MP4Atom *parent, const char *type);
  void Generate();
};
...
{
 public:
  MP4Avc1Atom(MP4Atom *parent, const char *type);
  void Generate();
};
...
class MP4WaveAtom : public MP4Atom 
{
 public:
  MP4WaveAtom(MP4Atom *parent, const char *type);
};

class MP4AlacAtom : public MP4Atom 
{
 public:
  MP4AlacAtom(MP4Atom *parent, const char *type);
   void Read();
};

class MP4DataAtom : public MP4Atom {
public:
	MP4DataAtom(MP4Atom *parent, const char *type);
  MP4DataAtom();
  void Read();
};
...
class MP4MetaItunes : public MP4Atom
{
public:
  MP4MetaItunes(MP4Atom *parent, const char *name);
};

class MP4Meta1Atom : public MP4Atom 
{
	public:
  MP4Meta1Atom(MP4Atom *parent, const char *name);
  void Read();
};

class MP4Meta2Atom : public MP4Atom {
 public:
  MP4Meta2Atom(MP4Atom *parent, const char *name);
  void Read();
};

class MP4Meta3Atom : public MP4Atom {
 public:
  MP4Meta3Atom(MP4Atom *parent, const char *name);
  void Read();
};
...
public:
	MP4StscAtom(MP4Atom *parent, const char *type);
	void Read();
};

class MP4StsdAtom : public MP4Atom {
public:
	MP4StsdAtom(MP4Atom *parent, const char *type);
	void Read();
};

class MP4StszAtom : public MP4Atom {
public:
	MP4StszAtom(MP4Atom *parent, const char *type);
	void Read();
	void Write();
};
