...
#define CHECK_ERROR(a, b, c) if ((a) == (b)) goto c
...
ebur128_state* ebur128_init(unsigned int channels,
  ...
  ebur128_init_filter(st);
    ...
    st->d->block_energy_histogram = malloc(1000 * sizeof(unsigned long));
		if (!st->d->block_energy_histogram)
			goto free_audio_data;
...
#else
//#pragma warning "manual FTZ is being used, please enable SSE2 (-msse2 -mfpmath=sse)"
#define TURN_ON_FTZ
#define TURN_OFF_FTZ
#define FLUSH_MANUALLY \
