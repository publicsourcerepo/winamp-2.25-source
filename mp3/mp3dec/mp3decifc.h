 ...
 * $Id: mp3decifc.h,v 1.1 2009/04/28 20:17:45 audiodsp Exp $
 */
...
public:
  ...
  virtual SSC DecodeFrame(unsigned char *pPcm,
                          int cbPcm,
                          int *pcbUsed,
  ...
  virtual SSC DecodeFrame(float *pPcm,
                          int cbPcm,
                          int *pcbUsed,
                          unsigned char *ancData,
                          int *numAncBytes,
...
/*
 * decode one mp3 frame to float
 */
LINKSPEC SSC MP3DECAPI mp3decDecodeToFloat
    (
     MP3DEC_HANDLE  handle,
     float         *pPcm,
     int            cbPcm,
...
/*
 * get last ancillary data package
 */
LINKSPEC SSC MP3DECAPI mp3decGetLastAnc
    (
     MP3DEC_HANDLE  handle,
     unsigned char *ancData,
     int *numAncBytes
