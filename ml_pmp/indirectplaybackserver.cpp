...
#include "../jnetlib/api_webserv.h"
#include "../jnetlib/api_onconncb.h"
#include "../jnetlib/api_connection.h"
#include "../jnetlib/api_httpserv.h"
#include "../jnetlib/api_pagegenerator.h"
#include "api.h"
...
static VOID CALLBACK APC_FindTrack(ULONG_PTR dwParam) {
	...
	for(int i=0; i<devices.GetSize(); i++) {
		...
		wchar_t buf[2048]; int len = 2047; buf[2047]=0;
...
static DWORD WINAPI ThreadFunc_Server(LPVOID lpParam) {
	...
	waServiceFactory *sf = WASABI_API_SVC->service_getServiceByGuid(webservGUID);
