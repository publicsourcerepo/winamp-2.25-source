#ifndef _NULLSOFT_WINAMP_DATAVIEW_GRAPHICS_HEADER
#define _NULLSOFT_WINAMP_DATAVIEW_GRAPHICS_HEADER
...
BOOL Graphics_GetLabelIdealSizeEx(HWND hwnd, const wchar_t *text, SIZE *size);
BOOL Graphics_GetLabelIdealSize(HWND hwnd, SIZE *size);


#endif //_NULLSOFT_WINAMP_DATAVIEW_GRAPHICS_HEADER
