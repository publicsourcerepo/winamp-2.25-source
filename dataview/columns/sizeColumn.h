#ifndef _NULLSOFT_WINAMP_DATAVIEW_SIZE_COLUMN_HEADER
#define _NULLSOFT_WINAMP_DATAVIEW_SIZE_COLUMN_HEADER
...
class SizeColumn : public Column
{
protected:
	SizeColumn(size_t valueId, ifc_viewcolumninfo *columnInfo);
	~SizeColumn();
...
#endif //_NULLSOFT_WINAMP_DATAVIEW_SIZE_COLUMN_HEADER