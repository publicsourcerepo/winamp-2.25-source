#ifndef _NULLSOFT_WINAMP_DATAVIEW_ALBUM_GROUP_PROVIDER_HEADER
#define _NULLSOFT_WINAMP_DATAVIEW_ALBUM_GROUP_PROVIDER_HEADER
...
class AlbumGroupProvider : public ifc_groupprovider
{
...
#endif //_NULLSOFT_WINAMP_DATAVIEW_ALBUM_GROUP_PROVIDER_HEADER