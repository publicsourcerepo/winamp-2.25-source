#ifndef NULLSOFT_ADDONS_PLUGIN_WASABI_CALLBACK_HEADER
#define NULLSOFT_ADDONS_PLUGIN_WASABI_CALLBACK_HEADER
...
#endif //NULLSOFT_ADDONS_PLUGIN_WASABI_CALLBACK_HEADER