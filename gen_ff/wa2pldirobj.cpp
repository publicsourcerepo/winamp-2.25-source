...
PlDirObject::~PlDirObject()
{
	...
	WASABI_API_SYSCB->syscb_deregisterCallback(static_cast<PlaylistCallbackI *>(this));
...
scriptVar PlDirScriptObjectController::pldir_showCurrentlyPlayingEntry(SCRIPT_FUNCTION_PARAMS, ScriptObject *o)
{
	...
	SendMessage(hPeWindow, WM_USER, 666, wa2.PE_getCurrentIndex());
