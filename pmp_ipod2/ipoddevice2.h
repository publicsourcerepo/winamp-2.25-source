...
class IpodDevice2 : public Device
{
public:
	...
	virtual bool hasArt(songid_t songid);
	...
	public:
		...
		Vector<IpodPlaylist*> ipodPlaylists;
		ArtDB * artdb;
		nu::PtrList<const ArtworkFormat> thumbs;

		virtual int parseiTunesDB(bool parseArt);
		IpodDevice2(wchar_t drive);
		~IpodDevice2();
	private:
};