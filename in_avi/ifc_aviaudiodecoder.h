...
public:
	...
	int DecodeChunk(uint16_t type, const void **inputBuffer, size_t *inputBufferBytes, void *outputBuffer, size_t *outputBufferBytes);
	void Flush();
...
inline int ifc_aviaudiodecoder::OutputFrameSize(size_t *frame_size)
{
...
inline int ifc_aviaudiodecoder::DecodeChunk(uint16_t type, const void **inputBuffer, size_t *inputBufferBytes, void *outputBuffer, size_t *outputBufferBytes)
{
