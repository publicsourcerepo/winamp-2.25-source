...
{
	const wchar_t *GetField(){return L"albumartist";}
...
{
	const wchar_t *GetField(){return L"artist";}
...
{
	const wchar_t *GetField(){return L"composer";}
...
{
	const wchar_t *GetField(){return L"genre";}
...
{
	const wchar_t *GetField(){return L"publisher";}
...
class YearFilter : public SimpleFilter
{
	...
	const wchar_t *GetField(){return L"year";}
...
{
	const wchar_t *GetField(){return L"podcastchannel";}
...
{
	const wchar_t *GetField(){return L"director";}
