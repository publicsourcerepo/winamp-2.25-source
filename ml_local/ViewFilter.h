...
{
	queryListItem() : name(0), albumGain(0), art(0), artist(0), genre(0), rating(0), gracenoteFileId(0), lastupd(0), length(0), size(0) {
...
public:
	...
	nu::PtrList<ListField> showncolumns;
	nu::PtrList<ListField> hiddencolumns;
