...
#include "../xml/expat/latin1tab.h"
#undef BT_COLON
#include "../xml/expat/asciitab.h"
        };
#endif
	...
	for (size_t i = 0; i != n; i++)
	{
		...
		default:
			//        if (xmltypecheck[c] != 0)
			{
				...
				int len = WideCharToMultiByte(CP_UTF8, 0, str, numChars, 0, 0, 0, 0);
				char *utf8 = (char *)malloc(len);
				WideCharToMultiByte(CP_UTF8, 0, str, numChars, utf8, len, 0, 0);
