...
void GuiObjectI::onTargetTimer() {
  ...
  if (!start_time)
	{
		n=0; 
		start_time=Std::getTickCount(); 
	}
  else
	{
		n=MulDiv(Std::getTickCount()-start_time,256,ttime);
	}
