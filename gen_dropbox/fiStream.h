#ifndef NULLSOFT_DROPBOX_PLUGIN_FILEINFO_STREAM_HEADER
#define NULLSOFT_DROPBOX_PLUGIN_FILEINFO_STREAM_HEADER
...
class StreamFileInfo : public IFileInfo, public GenericItemMeta
{
...
protected:
	StreamFileInfo(LPCTSTR pszUrl);
	virtual ~StreamFileInfo();
...
#endif //NULLSOFT_DROPBOX_PLUGIN_FILEINFO_STREAM_HEADER