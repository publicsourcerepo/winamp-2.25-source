...
CMapInfo::CMapInfo()
{
	strcpy(TypNamen[0],"TOSHIBA ");
	strcpy(TypNamen[1],"SONY    ");
	strcpy(TypNamen[2],"NEC     ");
	strcpy(TypNamen[3],"HITACHI ");
	strcpy(TypNamen[4],"YAMAHA  ");
	strcpy(TypNamen[5],"PIONEER ");
	strcpy(TypNamen[6],"IBM     ");
	strcpy(TypNamen[7],"PLEXTOR ");
	strcpy(TypNamen[8],"PHILIPS ");
	strcpy(TypNamen[9],"GRUNDIG ");
	strcpy(TypNamen[10],"HP      ");
	strcpy(TypNamen[11],"IMS     ");
	strcpy(TypNamen[12],"MITSUMI ");
	strcpy(TypNamen[13],"ATAPI   ");
	strcpy(TypNamen[14],"TOSHNEW ");
	strcpy(TypNamen[15],"RICOH   ");
	strcpy(TypNamen[16],"MATSHITA");
	strcpy(TypNamen[17],"PLASMON ");
	strcpy(TypNamen[18],"KODAK   ");
	strcpy(TypNamen[19],"TEAC    ");
	strcpy(TypNamen[20],"CyberDrv");
	strcpy(TypNamen[21],"MMC-2   ");	// pgo
...
{
	strcpy(TypNamen[0],"SONY    ");
	strcpy(TypNamen[1],"PIONEER ");
...
// ----------------------------------------------------------------------------------------
CSCSICD::CSCSICD (TDriveInfo &xInfo):Config(xInfo)
{
		...
		RunningNT)
	{
		...
		OSVERSIONINFO	osver;
		wchar_t CDDevice[10]=L"\\\\.\\x:";
		CDDevice[4]=(wchar_t)(Config.HostAdapterNumber + 'A');
		//For Windows NT 5 use other file flags
		memset( &osver, 0x00, sizeof(osver) );
		osver.dwOSVersionInfoSize = sizeof(osver);
		GetVersionEx( &osver );
		...
		m_hDriveEvent = CreateFile( CDDevice, dwFlags, FILE_SHARE_READ|FILE_SHARE_WRITE, NULL,OPEN_EXISTING, 0, NULL );
...
BOOL CSCSICD::WaitCDDA(BOOL bImmediate)
{
		...
		!bImmediate)
	{
		...
		if (abs(AktReadTime-StartReadTime)>12000)
		{
