...
int ADTS_MP2::Initialize(bool forceMono, bool reverseStereo, bool allowSurround, int maxBits, bool _allowRG, bool _useFloat) 
{
	allowRG = _allowRG;
	useFloat = _useFloat;
	int downmix = 0;
	...
	decoder = new CMpgaDecoder(&hooks, g_ds, downmix, (config_miscopts&1)/*crc*/);
#ifndef NO_MP3SURROUND
	if (allowSurround)
