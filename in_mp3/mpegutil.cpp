...
unsigned char eq_preamp;
unsigned char eq_enabled;
unsigned char eq_tab[10];

float g_vis_table[2][2][32][18];
...
void genSpec(char *tempdata, float *xr, int nch)
{
	...
	unsigned char *c = (unsigned char *)tempdata;
	{
		int x;
		int ex, sx;
		for (x = 0; x < 75; x++) 
