...
#include <memory.h>
#include <math.h>
#include "../mp3/mp3dec/mpegheader.h"
#include "api.h"
#include "resource.h"
#include "in2.h"
...
int ReadLAMEinfo(unsigned char *buffer, LAMEinfo *lameInfo)
{
	...
	{
		lameInfo->replaygain_track_gain = gain_word & 0x01FF;
	...
	{
		lameInfo->replaygain_album_gain = gain_word & 0x01FF;
