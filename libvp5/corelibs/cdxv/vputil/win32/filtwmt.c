...
__declspec(align(16)) INT16  BicubicFilters_wmt[8][32] = 
{
 ...
 *
 ****************************************************************************/
void FilterBlock_wmt( UINT8 *ReconPtr1, UINT8 *ReconPtr2, UINT16 *ReconRefPtr, UINT32 PixelsPerLine, INT32 ModX, INT32 ModY, BOOL UseBicubic )
{
	int diff;
    UINT8 Intermediate[256];
    ...
    if(UseBicubic)
    {
        ...
        {											        // Fractional pixel in horizontal only
                FilterBlock1d_h_wmt(ReconPtr1, Intermediate, PixelsPerLine, 1, 8, 8, BicubicFilters_wmt[ModX] );
        }
        else if (diff == (int)(PixelsPerLine) )				// Fractional pixel in vertical only
        {
                FilterBlock1d_v_wmt(ReconPtr1, Intermediate, PixelsPerLine, PixelsPerLine, 8, 8, BicubicFilters_wmt[ModY]);
        }
        else if(diff == (int)(PixelsPerLine - 1))			// ReconPtr1 is Top right
        {										
                FilterBlock2d_wmt( ReconPtr1-1, Intermediate, PixelsPerLine, BicubicFilters_wmt[ModX], BicubicFilters_wmt[ModY] );
        }
        else if(diff == (int)(PixelsPerLine + 1) )			// ReconPtr1 is Top left
        {	
                FilterBlock2d_wmt( ReconPtr1, Intermediate, PixelsPerLine, BicubicFilters_wmt[ModX], BicubicFilters_wmt[ModY] );
        }
    ...
    else
    {
        ...
        if( diff==1 )
        {	
            FilterUnpackBlock1d_hb8_wmt(ReconPtr1, (INT16*)ReconRefPtr, PixelsPerLine, 1, 8, 16, BilinearFilters_wmt[ModX] );
        ...
        {
            FilterUnpackBlock1d_vb8_wmt(ReconPtr1, (INT16*)ReconRefPtr, PixelsPerLine, PixelsPerLine, 8, 16, BilinearFilters_wmt[ModY]);    
            /*
        ...
        {										
            ...
            FilterUnpackBlock2dBil_wmt( ReconPtr1-1, (INT16*)ReconRefPtr, PixelsPerLine, BilinearFilters_wmt[ModX], BilinearFilters_wmt[ModY] );
            /*
        ...
        {	
            FilterUnpackBlock2dBil_wmt( ReconPtr1, (INT16*)ReconRefPtr, PixelsPerLine, BilinearFilters_wmt[ModX], BilinearFilters_wmt[ModY] );    
            /*
