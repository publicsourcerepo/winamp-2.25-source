...
void FillLoopFilterLimitValues_MMX ( void )
{
    ...
    for ( i=0; i<64; i++ )
	{
		LoopFilterLimitValuesV2_MMX[i*4+0] = (INT16)LoopFilterLimitValuesV2[i];
		LoopFilterLimitValuesV2_MMX[i*4+1] = (INT16)LoopFilterLimitValuesV2[i];
		LoopFilterLimitValuesV2_MMX[i*4+2] = (INT16)LoopFilterLimitValuesV2[i];
		LoopFilterLimitValuesV2_MMX[i*4+3] = (INT16)LoopFilterLimitValuesV2[i];
	}
}
