...
HWND CreateDummyWindow()
{
	...
	HWND dummy = CreateWindow(L"pmp_njb_window", L"pmp_njb_window", 0, 0, 0, 0, 0, NULL, NULL, plugin.hDllInstance, NULL);
...
int init()
{
	...
	long devCount = 0;
	hr = m_pCTJukebox2->GetDeviceCount2(&devCount);
...
void quit()
{
	...
	{
		HRESULT hr;
		hr=m_pCTJukebox2->ShutDown2();
		hr=m_pCTJukebox2->Release();
		m_pCTJukebox2 = 0;
	}
