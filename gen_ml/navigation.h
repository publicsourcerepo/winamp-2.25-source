...
// LOCALE_INVARIANT mapping for XP+ and pre-XP based systems
// pass is_xp_plus as a indication of if you are on XP and up or Win2k and below
#define NICF_LOCALE_INVARIANT(is_xp_plus) (!is_xp_plus?MAKELCID(MAKELANGID(LANG_ENGLISH, SUBLANG_ENGLISH_US), SORT_DEFAULT):LOCALE_INVARIANT)
