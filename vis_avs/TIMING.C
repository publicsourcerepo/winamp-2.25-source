/*
** Nullsoft Nitrane - CONFIDENTIAL
** timing.c: benchmarking code -- not in release builds
**
** Uses pentium RDTSC. If TIMING not defined in timing.h,
** no additional code is generated.
**
** Copyright 1997-1998, Nullsoft Inc. All rights reserved.
**
*/
