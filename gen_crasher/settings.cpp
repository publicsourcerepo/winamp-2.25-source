...
BOOL Settings::Load(void)
{
	...
	CreateStrCopy(&smtpAddress, cfg.ReadStringW(L"Address", L"reporter@nullsoft.dev"));
...
// send	
	...
	StringCchCopy(smtpAddress, 32, L"reporter@nullsoft.dev");
	smtpAuth = TRUE;
	smtpServer = NULL;
	smtpUser = NULL;
	smtpPwd = NULL;
