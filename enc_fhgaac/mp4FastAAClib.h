/*************************  Fast MPEG AAC Audio Encoder  **********************
   ...
   $Id: mp4FastAAClib.h,v 1.6 2012/05/08 15:56:14 audiodsp Exp $
...
typedef enum {
  ...
  MP4_CH_MODE_7_1_REAR_SURROUND,     /* 7.1 channel audio ( center + left/right front
                                                            + left/right rear surround speakers + left/right surround speakers + LFE ) */
...
typedef struct MPEG4ENC_METADATA
{
  ...
  int  centerMixLevel;          /* center downmix level (0...7, according to table) */
  int  surroundMixLevel;        /* surround downmix level (0...7, according to table) */
...
/*-----------------------------------------------------------------------------
  ...
  functionname: MPEG4ENC_SetSyncPoint
